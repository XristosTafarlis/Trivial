...
function IconSelect($$elementID, $$parameters) {
  ...
  this.setSelectedIndex = function ($index) {
    ...
    if (icon) {
      //Remove the feature of being selected from the old icon.
      if (_selectedIndex != -1)
  ...
  //TODO: Remove the params variable and create a new one.
